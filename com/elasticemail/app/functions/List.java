...
public class List extends API
{
     ...
     * @throws Exception
     */
    public int createFromCampaign(int campaignID, String listName, ApiTypes.LogJobStatusList statuses) throws Exception {
       HashMap<String, String> values = new HashMap<String, String>();
       values.put("apikey", API_KEY);
     ...
     * @throws Exception
     */
    public ApiTypes.ListList list(Date from, Date to) throws Exception {
       HashMap<String, String> values = new HashMap<String, String>();
       values.put("apikey", API_KEY);
     ...
     * @throws Exception
     */
    public void moveContacts(String oldListName, String newListName, StringList emails, Boolean moveAll, ApiTypes.ContactStatusList statuses) throws Exception {
       HashMap<String, String> values = new HashMap<String, String>();
       values.put("apikey", API_KEY);
