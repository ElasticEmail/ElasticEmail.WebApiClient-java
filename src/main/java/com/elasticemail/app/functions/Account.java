...
public class Account extends API
{
     ...
     * @throws Exception
     */
    public ApiTypes.SubAccountArray getSubAccountList() throws Exception {
       HashMap<String, String> values = new HashMap<String, String>();
       values.put("apikey", API_KEY);
     ...
     * @throws Exception
     */
    public StringArray manageApiKeys(String apiKey, ApiTypes.APIKeyAction action) throws Exception {
       HashMap<String, String> values = new HashMap<String, String>();
       values.put("apikey", API_KEY);
       values.put("apiKey", apiKey);
       values.put("action", String.valueOf(action));
       return uploadValues(API_URI + "/account/manageapikeys", values, StringArray.class);
   }
