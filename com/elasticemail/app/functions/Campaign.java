...
public class Campaign extends API
{
     ...
     * @throws Exception
     */
    public ApiTypes.ExportLink export(Iterable<int> channelIDs, ApiTypes.ExportFileFormats fileFormat, ApiTypes.CompressionFormat compressionFormat, String fileName) throws Exception {
       HashMap<String, String> values = new HashMap<String, String>();
       values.put("apikey", API_KEY);
