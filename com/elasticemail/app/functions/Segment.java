...
public class Segment extends API
{
     ...
     * @throws Exception
     */
    public ApiTypes.SegmentList list(Boolean includeHistory, Date from, Date to) throws Exception {
       HashMap<String, String> values = new HashMap<String, String>();
       values.put("apikey", API_KEY);
     ...
     * @throws Exception
     */
    public ApiTypes.SegmentList loadByName(StringList segmentNames, Boolean includeHistory, Date from, Date to) throws Exception {
       HashMap<String, String> values = new HashMap<String, String>();
       values.put("apikey", API_KEY);
       ...
       if (from != null) values.put("from", String.valueOf(from));
       if (to != null) values.put("to", String.valueOf(to));
       return uploadValues(API_URI + "/segment/loadbyname", values, ApiTypes.SegmentList.class);
   }
